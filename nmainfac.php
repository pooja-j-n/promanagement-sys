 ...
 <img class="img-circle" src="img/logo.jpg" alt="logo" height="50px" width="50px">
			...
			<nav id="nav_menu">
				<ul>
					...
					<li><a href="addrole_h.php">Add my Role</a></li>
					<li><a href="addmarks_h.php">Add Marks</a></li>
					<li><a href="ados_h.php">Add Project Schedule</a></li>
					<li><a href="vp_h.php">View Projects</a></li>
					<li><a href="vt_h.php">View Teams</a></li>
...
?>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
		...
		<br><center><p style="color:black;"><font size="6"><b> PROJECT MANAGEMENT SYSTEM<br>FACULTY PORTAL </b></font></p><center>
      </div>
