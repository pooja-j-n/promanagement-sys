...
<html lang="en">
  <head>
  <?php
  //echo "<script>console.log(".$_POST['t1'].")</script>";
session_start();
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
			...
			<li><a href="#s8"  data-toggle="modal" role="button">Evaluate</a></li> 
    ...
    <div class="site-wrapper">
      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
		  ...
		  <h3>Evaluate</h3><br><br>
            <?php echo"<center><form method='post' action='eval2_connection.php' class='form-horizontal' style='margin-left:40px; width:300px;border:2px;' >";
			$title=$_POST['t1'];
				echo "USN";
				...
				echo "<input type='submit' class='btn btn-primary'></input></form></center>";
